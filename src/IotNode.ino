 ...
 *
 * Cite:
 * S. D. Correia, R. Perez, J. Matos-Carvalho and V. R. Q. Leithardt, "µJSON, a Lightweight 
 * Compression Scheme for Embedded GNSS Data Transmission on IoT Nodes," 2022 5th Conference 
 * on Cloud and Internet of Things (CIoT), 2022, pp. 232-238, doi: 10.1109/CIoT53061.2022.9766635.
 *
 */ 
